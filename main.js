...
const lyricsData = {
    0: [
        { time: 0, text: " " },
        { time: 17.15, text: "I could lift you up" },
        { time: 20.78, text: "I could show you what you want to see" },
        { time: 23.21, text: "And take you where you want to be" },
        { time: 25.90, text: "You could be my luck" },
        { time: 29.11, text: "Even if the sky is falling down" },
        { time: 31.30, text: "I know that we'll be safe and sound" },
        { time: 36.42, text: "We're safe and sound" },
        { time: 41.67, text: "You know my river won't evaporate" },
        { time: 45.04, text: "You know my river won't evaporate" },
        { time: 47.41, text: "This world, we still appreciate" },
        { time: 50.19, text: "You could be my luck" },
        { time: 53.35, text: "Even in a hurricane of frowns" },
        { time: 55.74, text: "I know that we'll be safe and sound" },
        { time: 58.26, text: "We're safe and sound (safe and sound)" },
        { time: 64.80, text: "We're safe and sound (hold your ground)" },
        { time: 68.94, text: "We're safe and sound (safe and sound)" },
        { time: 74.75, text: "I could show you love" },
        { time: 77.89, text: "In a tidal wave of mystery" },
        { time: 80.32, text: "You'll still be standing next to me" },
        { time: 82.77, text: "You could be my luck" },
        { time: 85.75, text: "Even if we're six feet underground" },
        { time: 88.26, text: "I know that we'll be safe and sound" },
        { time: 97.45, text: "We're safe and sound" },
        { time: 123.48, text: "I could lift you up" },
        { time: 126.59, text: "I could show you what you want to see" },
        { time: 129.05, text: "And take you where you want to be" },
        { time: 131.65, text: "You could be my luck" },
        { time: 134.81, text: "Even if the sky is falling down" },
        { time: 137.13, text: "I know that we'll be safe and sound" },
        { time: 140.03, text: "I could lift you up" },
        { time: 142.88, text: "I could show you what you want to see" },
        { time: 145.25, text: "And take you where you want to be" },
        { time: 147.85, text: "You could be my luck" },
        { time: 151.08, text: "Even if the sky is falling down" },
        { time: 153.49, text: "I know that we'll be safe and sound" },
        { time: 158.52, text: "We're safe and sound" },
        { time: 162.52, text: "We're safe and sound" },
        { time: 166.66, text: "We're safe and sound" },
        { time: 170.81, text: "We're safe and sound (safe and sound)" },
        { time: 174.78, text: "We're safe and sound (safe and sound)" },
        { time: 177.82, text: "We're safe and sound (hold your ground)" },
        { time: 182.98, text: "We're safe and sound (safe and sound)" },
        { time: 186.92, text: "We're safe and sound" }
    ],
    1: [
        { time: 0, text: " " },
        { time: 0.12, text: "Take down all the mirrors in my house, I hate my nose, eyes and my mouth" },
        { time: 4.14, text: "I hate the jokes I laugh about, I hate the hoes I'm sad about" },
        { time: 8.01, text: "She calls up my phone, ringing, ringing, ringing, ringing" },
        { time: 11.32, text: "Baby, just leave me alone" },
        { time: 12.52, text: "She saw all my flaws" },
        { time: 14.15, text: "Baby, won't you tell me what the fuck I'm doing wrong?" },
        { time: 16.31, text: "Ooh, I hate the feeling of my doubts, so I wanna die on top of my couch" },
        { time: 20.45, text: "Oh well, oh well, oh well" },
        { time: 24.67, text: "What do you want from me?" },
        { time: 26.48, text: "I'm never ever good for anything" },
        { time: 28.28, text: "Why do you talk to me?" },
        { time: 30.23, text: "I'll never ever buy a wedding ring" },
        { time: 32.24, text: "Ooh, I have a question" },
        { time: 34.80, text: "I'm like, \"Ooh, I have a question\"" },
        { time: 36.27, text: "Ooh, I have a question" },
        { time: 38.02, text: "I'm like, \"Ooh I have a question for you, baby\"" },
        { time: 40.70, text: "How do I really even matter to you" },
        { time: 42.78, text: "When you was outside laughing with another dude?" },
        { time: 44.94, text: "Oh, oh, oh" },
        { time: 47.33, text: "You make me hate my face so much, oh" },
        { time: 49.29, text: "When will I ever feel that (oh shit, a ghost)" },
        { time: 52.90, text: "Take down all the mirrors in my house, I hate my nose, eyes and my mouth" },
        { time: 56.91, text: "I hate the jokes I laugh about, I hate the hoes I'm sad about" },
        { time: 60.85, text: "She calls up my phone, ringing, ringing, ringing, ringing" },
        { time: 64.15, text: "Baby, just leave me alone" },
        { time: 65.35, text: "She saw all my flaws" },
        { time: 66.50, text: "Baby, won't you tell me what the fuck I'm doing wrong?" },
        { time: 69.22, text: "Ooh, I hate the feeling of my doubts, so I wanna die on top of my couch" },
        { time: 73.35, text: "Oh well, oh well, oh well" },
        { time: 77.38, text: "What do you want from me?" },
        { time: 79.12, text: "I'm never ever good for anything" },
        { time: 80.92, text: "Why do you talk to me?" },
        { time: 83.16, text: "I'll never ever buy a wedding ring" },
        { time: 85.50, text: "Take down all the mirrors in my house, I hate my nose, eyes and my mouth" },
        { time: 90.03, text: "I hate the jokes I laugh about, I hate the hoes I'm sad about" },
        { time: 95.13, text: "She calls up my phone, ringing, ringing, ringing, ringing" },
        { time: 98.99, text: "Baby, just leave me alone" },
        { time: 100.28, text: "She saw all my flaws" },
        { time: 101.34, text: "Baby, won't you tell me what the fuck I'm doing wrong?" }
    ],
    2: [
        { time: 0, text: " " },
        { time: 17.31, text: "Ты прекрасней первых двух глотков холодного пивка" },
        { time: 21.44, text: "Но в твоей дурной голове проблем безумно дохуя" },
        { time: 25.82, text: "Что-то ломается внутри, ты девочка-авария" },
        { time: 30.13, text: "Ты даже до конца не веришь, дура, реален ли я" },
        { time: 35.0, text: "А я вытащу тебя со дна, ведь только лишь одна" },
        { time: 40.23, text: "Мне ты нужна, чтоб чувствовать себя живым, блять" },
        { time: 45.27, text: "Я сгорю до тла, лишь бы ты могла" },
        { time: 50.06, text: "Хоть на крупицу быть ещё со мной счастливей" },
        { time: 71.23, text: "На твоей белой, как мазик, коже блядские порезы" },
        { time: 75.49, text: "Дай мне время и я приручу всех твоих диких бесов" },
        { time: 80.0, text: "Если надо, стану твоим личным псом-поводырём" },
        { time: 84.29, text: "И если ты упадёшь в яму, в яме мы сгниём вдвоём" },
        { time: 88.78, text: "А я вытащу тебя со дна, ведь только лишь одна" },
        { time: 94.95, text: "Мне ты нужна, чтоб чувствовать себя живым, блять" },
        { time: 99.57, text: "Я сгорю до тла, лишь бы ты могла" },
        { time: 103.80, text: "Хоть на крупицу быть ещё со мной счастливей" },
        { time: 107.36, text: "Я спущу огонь с небес в твои потухшие глаза" },
        { time: 111.27, text: "Я за тебя хоть в пиздорез, хоть в Рай, хоть в Ад я тоже за!" },
        { time: 115.70, text: "Поверну время вспять, отстрою все сожжённые мосты" },
        { time: 120.18, text: "Я научу тебя опять ждать от любимого цветы" },
        { time: 125.89, text: "А я вытащу тебя со дна, ведь только лишь одна" },
        { time: 130.86, text: "Мне ты нужна, чтоб чувствовать себя живым, блять" },
        { time: 135.50, text: "Я сгорю до тла, лишь бы ты могла" },
        { time: 140.13, text: "Хоть на крупицу быть ещё со мной счастливей" }
    ],
    3: [
        { time: 0, text: " " },
        { time: 16.18, text: "без тебя я не могу дышать," },
        { time: 19.70, text: "я не могу уснуть, я не могу..." },
        { time: 24.36, text: "...возвращайся" },
